...
module au_top_0 (
  ...
  wire [1-1:0] M_modulo_out;
  reg [1-1:0] M_modulo_a;
  reg [1-1:0] M_modulo_b;
  modulo_1 modulo (
    .a(M_modulo_a),
    .b(M_modulo_b),
    .out(M_modulo_out)
  ...
  always @* begin
    ...
    case (M_state_q)
      ...
      RANDB3_state: begin
        ...
        M_modulo_a = a_actl / b_actl;
        M_modulo_b = 1'h1;
        if (M_modulo_out != 1'h0) begin
          M_state_d = RANDB3_state;
        end else begin
      ...
      RANDCF_state: begin
        ...
        if (c_temp > 4'h9) begin
          c_temp = c_temp - 4'ha;
          M_modulo_a = a_actl / b_actl / c_actl;
          M_modulo_b = 1'h1;
        end else begin
          M_modulo_a = a_actl / b_actl / c_actl;
          M_modulo_b = 1'h1;
